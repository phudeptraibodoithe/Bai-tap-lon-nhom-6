...
public class EditItemController extends BaseController implements Initializable, SocketListener {
    ...
    public void saveItem(ActionEvent e) {
        ...
        SocketHelper.sendRequest(ServerEvent.EDIT_ITEM, payload);
    }

    public void deleteItem(ActionEvent e) {
        if (AlertUtils.showConfirmation("Cảnh báo Xóa", "Bạn có chắc chắn muốn xóa (hủy) sản phẩm này không?\nHành động này không thể hoàn tác!")) {
            SocketHelper.sendRequest(ServerEvent.CANCEL_AUCTION, currentSessionId);
        }
    }
