...
public class AdminMoneyController extends BaseController implements Initializable, SocketListener {
    ...
    private void handleTransaction() {
        ...
        try {
            ...
            SocketHelper.sendRequest(ServerEvent.TRANSACTION, amountToSend);
