    ...
    private void handleCommand(String input) {
        ...
        switch (action) {
            case "LOGIN": // LOGIN|user|pass
                ...
                ResponseCode loginRes = userManager.login(parts[1], parts[2], this);
            ...
            case "PROFILE":
                ...
                if (userProfile != null) {
                    out.println("PROFILE_INFO|" + userProfile.getAccountName() + "|" + userProfile.getNickname() + "|" + userProfile.getBalance());
                }
                break;
            ...
            case "UPDATE_PROFILE":
                ...
                // FIX: Thêm kiểu dữ liệu "User" vào trước biến updateUser
