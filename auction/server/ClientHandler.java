    ...
    private void handleCommand(String input) {
        ...
        switch (action) {
            case "JOIN":
                ...
                // THONG BAO TRANG THAI NEU PHONG ĐA XONG
                if (currentRoom.isFinished()) {
                    out.println("LƯU Ý: Phien dau gia nay da KET THUC!");
                    out.println("Gia cuoi cung: " + currentRoom.getCurrentPrice());
                }
                break;
            ...
            case "BID":
                ...
                if (currentRoom.isFinished()) {
                    out.println("THONG BAO: Phien dau gia nay da ket thuc. Ban khong the dat gia nua!");
                    return;
                }
